...
const links = [
  ...
  { href: '/company/candidates', label: 'Search Candidates', icon: Search },
...
export function CompanySidebar() {
  ...
  return (
    ...
    <aside className="fixed left-0 top-14 z-30 hidden h-[calc(100vh-3.5rem)] w-[260px] flex-col border-r border-black/[0.06] bg-white/72 backdrop-blur-xl md:flex">
      ...
      <nav className="flex flex-1 flex-col gap-1 p-4 pt-6" aria-label="Company navigation">
...
export function CompanyBrandMark() {
  ...
  return (
    ...
    <Link href="/company/dashboard" className="group flex items-center gap-2 text-white outline-offset-4">
