      ...
      >
        ...
        <CardContent className="relative p-5">
          ...
          {loading ? (
            ...
            <Skeleton className="mt-3 h-9 w-16 rounded-lg bg-slate-100" />

          ) : (

            <p className="relative mt-2 text-3xl font-semibold tabular-nums tracking-tight text-[#0f172a]">{value}</p>
