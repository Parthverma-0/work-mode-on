...
import { ChevronDown, X, Zap, ArrowRight } from 'lucide-react'
  ...
  return (
    <>
      <nav className="glass-navbar fixed top-0 z-50 flex h-14 w-full items-center gap-4 px-4 sm:px-8">
        <Link
          href="/"
          className="flex shrink-0 items-center gap-2.5 rounded-lg outline-offset-4 transition-opacity hover:opacity-90"
        >
          <motion.span
            className="relative flex h-9 w-9 items-center justify-center overflow-hidden rounded-xl bg-gradient-to-br from-[#6366f1] to-[#4F46E5] shadow-lg shadow-[#4F46E5]/25"
            whileHover={reduceMotion ? undefined : { rotate: [-1, 1, 0], transition: { duration: 0.45 } }}
          >
            ...
            <div className="mx-auto max-w-7xl px-4 py-10 sm:px-8 sm:py-12">
              <div className="mb-8 flex items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm font-semibold tracking-tight text-white">Work Mode On</span>
                </div>
